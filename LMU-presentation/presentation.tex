...
\begin{frame}
  ...
  \begin{itemize}
  \item<7-> \(f(x_{\mathtt{temperature}}, x_{\mathtt{humidity}} | x_{\mathtt{is\_weekday}} = \{T, F\}) \rightarrow RA^2M: 2 \times 2D\)-plots \only<9> {\textcolor{green}{Explainable}}
    \item<8-> \(f(x_{\mathtt{temperature}}| x_{\mathtt{humidity}} = \{high, low\}, x_{\mathtt{is\_weekday}} = \{T, F\}) \rightarrow\) RAM with two conditions: $4 \times 2D$ plots \only<9> {\textcolor{green}{Explainable}}
  \end{itemize}
